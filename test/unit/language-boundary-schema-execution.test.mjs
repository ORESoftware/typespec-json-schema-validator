...
test('all boundary schemas are structurally valid Draft 2020-12 documents', async () => {
  for (const name of [
    'language-boundaries.schema.json',
...
test('manifest schema accepts explicit booleans and rejects string substitutes', async () => {
  const document = await schema('language-boundaries.schema.json');
  const manifest = {
