...
- Both low-level and preferred current-input runtime admission paths now return a separately identifiable decision receipt instead of reusing the untrusted adapter-evidence schema identifier.
